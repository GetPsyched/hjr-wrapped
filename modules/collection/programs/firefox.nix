{
  ...
  mkSearchSettings = profile: let
    # https://github.com/mozilla-firefox/firefox/blob/d5171e9e0f4729494423b0524f289073e0f0cb6c/toolkit/components/search/SearchUtils.sys.mjs#L389-L425
    searchDisclaimer =
                    ...
                    options = {
                      target = mkOption {
                        ...
                        default =
                          ...
                          else "${outerConfig.xdg.config.directory}/mozilla/firefox/${config.path}/earch.json.mozlz4";
